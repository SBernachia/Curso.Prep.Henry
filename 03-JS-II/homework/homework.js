...
function fizzBuzz(numero) {
  ...
  if (numero%3 == 0 && numero%5 == 0) {return "fizzbuzz"} else if (numero%5 ==0)
...
function operadoresLogicos(num1, num2, num3) {
  ...
  if (num1>0 && num2 >0 && num3 >0 && num1 > num2 && num1 > num3 && num1 >0 ) {return "Número 1 es mayor y positivo"} 
  else if (num1 < 0 || num2 < 0 || num3 < 0) {return "Hay negativos"}
  else if (num1>0 && num2 >0 && num3 >0 && num3 > num2 && num3 > num1) {return num3 + 1}
...
function esPrimo(numero) {
  ...
  if (numero !== 0 && numero !== 1) {  
    for (var i=2; i<numero;i++) {
      if (numero%i !== 0) {} else {return false}
    }
    return true
  }     
  else {return false}
